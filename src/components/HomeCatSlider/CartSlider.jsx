      ...
      >
        <SwiperSlide>
          ...
          <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col'>
            <img src="./src/images/file_1734525204708_fash.png" alt="" className='w-[60px] transition-all' />
        ...
        <SwiperSlide>
          <Link to="/">
          <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col'>
            <img src="./src/images/file_1734525218436_ele.png" alt="" className='w-[60px] transition-all' />
        ...
        <SwiperSlide>
          <Link to="/">
          <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col'>
            <img src="./src/images/file_1734525255799_beauty.png" alt="" className='w-[60px] transition-all' />
        ...
        <SwiperSlide>
          <Link to="/">
          <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col'>
            <img src="./src/images/file_1734525239704_foot.png" alt="" className='w-[60px] transition-all' />
